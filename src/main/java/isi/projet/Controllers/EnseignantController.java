...
//	editer enseignant
	...
	public ResponseEntity<String> updateEnseignat(@PathVariable String email,
...
//    recupperer l'ensaigant avec sont modules ainsi les heures affecter a lui
	@GetMapping("/AllInformations")
	public List<Object> getinformation() {
		return ensignantrepo.getEnseingantModulesHeures();
	}
}
